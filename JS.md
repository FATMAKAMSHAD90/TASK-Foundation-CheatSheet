...
- `{ }`: is mainly used for `scopes: functions, if else, string interpolation, objects`
- `( )`: is mainly used for `conditon, mathmatical priortities, function parameter`
- `[ ]`: is mainly used for `arrays, accessing objects dynamically`
